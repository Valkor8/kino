...
const API = class {
  ...
  getFilms() {
    ...
    return this._load({url: `movies`})
      .then(_models_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilms)
  ...
  updateFilms(id, data) {
    return this._load({
      url: `movies/${id}`,
      method: `PUT`,
      body: JSON.stringify(_models_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].toRAW(data)),
    ...
    .then((filmData) => {
      ...
      return _models_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilm(filmDataWithComments);
    })
...
class AbstractSmartComponent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  recoveryListeners() {
    throw new Error(`Abstarct method not implemented: recoveryListeners`);
  }
...
/* harmony import */ var _utils_moment_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/moment.js */ "./src/utils/moment.js");
  ...
  return (
    `<article class="film-card">
        ...
        <p class="film-card__info">
          <span class="film-card__year">${(0,_utils_moment_js__WEBPACK_IMPORTED_MODULE_2__.getDateForMoment)(film.filmYear, `YYYY`)}</span>
          <span class="film-card__duration">${(0,_utils_moment_js__WEBPACK_IMPORTED_MODULE_2__.getDuration)(film)}</span>
...
class FilmCards extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(film) {
    super();
    this.film = film;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "localEmotions": () => (/* binding */ localEmotions),
...
/* harmony import */ var _utils_moment_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/moment.js */ "./src/utils/moment.js");
    ...
    arrComments.push(`<li class="film-details__comment">
      ...
      <div>
        ...
        <p class="film-details__comment-info">
          ...
          <span class="film-details__comment-day">${(0,_utils_moment_js__WEBPACK_IMPORTED_MODULE_1__.getDateForMoment)(comment.date, `YYYY/MM/DD HH:mm`)}     ${(0,_utils_moment_js__WEBPACK_IMPORTED_MODULE_1__.getHumanizeDate2)(comment.date)}</span>
            ...
            <div class="film-details__info">
              ...
              <table class="film-details__table">
                ...
                <tr class="film-details__row">
                  ...
                  <td class="film-details__cell">${(0,_utils_moment_js__WEBPACK_IMPORTED_MODULE_1__.getDateForMoment)(film.filmYear, `DD MMMM YYYY`)}</td>
                </tr>
                <tr class="film-details__row">
                  <td class="film-details__term">Runtime</td>
                  <td class="film-details__cell">${(0,_utils_moment_js__WEBPACK_IMPORTED_MODULE_1__.getDuration)(film)}</td>
                </tr>
                <tr class="film-details__row">
...
class FilmPopup extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ MessageLoading)
/* harmony export */ });
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
...
class MessageLoading extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  deleteMessage() {
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(this);
  }
}
  ...
  setSortTypeChangeHandler(handler) {
    this.getElement().addEventListener(`click`, (evt) => {
      ...
      Array.from(this.getElement().querySelectorAll(`.sort__button`)).forEach((btn) => {
        if (btn.dataset.id === this._currentSortType) {
...
/***/ "./src/components/stats-component.js":
/*!*******************************************!*\
  !*** ./src/components/stats-component.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ StatsComponent)
/* harmony export */ });
...
/* harmony import */ var _mock_random_rating_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../mock/random-rating.js */ "./src/mock/random-rating.js");
...
const getWatchedFilmDurationInHours = (films) => {
  ...
  const days = moment__WEBPACK_IMPORTED_MODULE_0___default().duration(filmMinutes * 1000 * 60).days();
  const hours = moment__WEBPACK_IMPORTED_MODULE_0___default().duration(filmMinutes * 1000 * 60).hours();
...
const getFilterHistoryInTodayFilms = (films) => {
  ...
  films.forEach((item) => {
    const date = (new Date() - moment__WEBPACK_IMPORTED_MODULE_0___default()(item.filter.watchingDate)) / 1000 / 60 / 60;
    if (date < 24) {
  ...
  return (
    `<section id="statistic" class="statistic">
      <p class="statistic__rank">
        ...
        <span class="statistic__rank-label">${_mock_random_rating_js__WEBPACK_IMPORTED_MODULE_4__.randomProfileRating}</span>
      </p>
      ...
      <ul class="statistic__text-list">
        ...
        <li class="statistic__text-item">
          ...
          <p class="statistic__item-text">${getWatchedFilmDurationInHours(films)} <span class="statistic__item-description">h</span> ${moment__WEBPACK_IMPORTED_MODULE_0___default().duration(getWatchedFilmDurationInMunites(films) * 1000 * 60).minutes()} <span class="statistic__item-description">m</span></p>
        </li>
        <li class="statistic__text-item">
...
class StatsComponent extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(model) {
    super();
  ...
  chart() {
    ...
    const myChart = new chart_js__WEBPACK_IMPORTED_MODULE_2__.Chart(statisticCtx, {
...
/* harmony import */ var _utils_handlers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/handlers.js */ "./src/utils/handlers.js");
...
class MovieController {
  ...
  render(film) {
    ...
    this.filmCards = new _components_film_card_js__WEBPACK_IMPORTED_MODULE_0__["default"](film);
    this.filmPopup = new _components_film_details_popup_js__WEBPACK_IMPORTED_MODULE_1__["default"](film);
    ...
    const onShowPopup = () => {
      ...
      (0,_utils_handlers_js__WEBPACK_IMPORTED_MODULE_3__.setFilmPopupHandlers)(film, this.filmPopup, this._onDataChange);
    };
    ...
    const addCommentHandler = (evt) => {
      if ((evt.ctrlKey || evt.metaKey) && evt.key === `Enter`) {
        ...
        const textComment = (0,he__WEBPACK_IMPORTED_MODULE_4__.encode)(notSanitazedInputValue);
    ...
    const onRemovePopupEsc = (evt) => {
      if (evt.key === `Escape` || evt.key === `Esc`) {
        this._popup = false;
        (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.remove)(this.filmPopup);
    ...
    if (oldFilm && oldPopup) {
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.replace)(this.filmCards, oldFilm);
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.replace)(this.filmPopup, oldPopup);
      ...
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.render)(this._container, this.filmCards);
    }

    this.filmCards.setClickHadnler(onShowPopup);

    (0,_utils_handlers_js__WEBPACK_IMPORTED_MODULE_3__.setFilmCardsHandlers)(film, this.filmCards, this._onDataChange);
  }
  ...
  destroy() {
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.remove)(this.filmPopup);
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.remove)(this.filmCards);
  }
}
...
/* harmony export */ });
/* harmony import */ var _components_film_card_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/film-card.js */ "./src/components/film-card.js");
/* harmony import */ var _components_profile_rating_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/profile-rating.js */ "./src/components/profile-rating.js");
...
/* harmony import */ var _components_footer_statistic_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/footer-statistic.js */ "./src/components/footer-statistic.js");
...
/* harmony import */ var _components_button_show_more_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/button-show-more.js */ "./src/components/button-show-more.js");
/* harmony import */ var _movie_controller_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./movie-controller.js */ "./src/controllers/movie-controller.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _mock_random_rating_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../mock/random-rating.js */ "./src/mock/random-rating.js");
/* harmony import */ var _mock_random_generator_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../mock/random-generator.js */ "./src/mock/random-generator.js");
/* harmony import */ var _models_movie_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../models/movie.js */ "./src/models/movie.js");
...
const TOTAL_FILMS = (0,_mock_random_generator_js__WEBPACK_IMPORTED_MODULE_11__.getRandomInt)(1000, 100000);
...
const renderFilms = (container, films, onDataChange, onViewChange, api) => {
  return films.map((film) => {
    const movieController = new _movie_controller_js__WEBPACK_IMPORTED_MODULE_8__["default"](container, onDataChange, onViewChange, api);
...
class PageController {
  constructor(container, filmsModel, siteMenuController, api) {
    ...
    this._sort = new _components_sort_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this.filmCards = new _components_film_card_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._buttonShowMore = new _components_button_show_more_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
    this._topRated = new _components_top_rated_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._mostCommented = new _components_most_commented_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
  ...
  render() {
    ...
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(header, new _components_profile_rating_js__WEBPACK_IMPORTED_MODULE_1__["default"](_mock_random_rating_js__WEBPACK_IMPORTED_MODULE_10__.randomProfileRating));

    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.renderContainer)(this._container, this.filmCards);
    ...
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(this._filmsElement, this._sort, `afterbegin`);

    if (this._films.length === 0 || !this._films) {
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(this._container, new _components_no_films_js__WEBPACK_IMPORTED_MODULE_6__["default"]());
      return;
    }
    ...
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(filmlist, this._buttonShowMore);

    this._renderTopRaited();

    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.renderContainer)(this._filmsElement, this._mostCommented);
    this._renderMostCommented();

    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(footerStatistics, new _components_footer_statistic_js__WEBPACK_IMPORTED_MODULE_3__["default"](TOTAL_FILMS));
  }
  ...
  _renderTopRaited() {
    ...
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.renderContainer)(this._filmsElement, this._topRated);
  ...
  _setSortTypeChangeHadnler() {
    this._sort.setSortTypeChangeHandler((sortType) => {
      this._removeFilms();
      this._filmCardsSort = (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.renderSortFilms)(this._filmsModel.getFilms(), sortType);
  ...
  _renderOnButtonClick() {
    const renderOnButtonClick = () => {
      ...
      if (this._filmAmount >= this._filmCardsSort.length) {
        (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.remove)(this._buttonShowMore);
      }
    };
  ...
  _replaceSort() {
    ...
    this._sort = new _components_sort_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.replace)(this._sort, oldSort);
...
/***/ "./src/controllers/site-menu-controller.js":
/*!*************************************************!*\
  !*** ./src/controllers/site-menu-controller.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SiteMenuController": () => (/* binding */ SiteMenuController)
/* harmony export */ });
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _components_site_menu_and_stats__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/site-menu-and-stats */ "./src/components/site-menu-and-stats.js");
...
class SiteMenuController {
  ...
  render() {
    this._siteMenu = new _components_site_menu_and_stats__WEBPACK_IMPORTED_MODULE_1__["default"](this._filmModel.getFilmsAll());

    (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.render)(this._container, this._siteMenu);

    this._siteMenu.onFilterClick(this._filterClickChangeHandler());
  }

  _onFilterCountChange() {
    (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.remove)(this._siteMenu);

    this._siteMenu = new _components_site_menu_and_stats__WEBPACK_IMPORTED_MODULE_1__["default"](this._filmModel.getFilmsAll());

    (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.render)(this._container, this._siteMenu, `afterbegin`);
  ...
  _filterClickChangeHandler() {
    return (evt) => {
      ...
      if (evt.target.dataset.name === _const__WEBPACK_IMPORTED_MODULE_2__.FilterType.WATCHLIST) {
        this._onFilterChange(evt.target.dataset.name);
        this._siteMenu.changeActive(`WATCHLIST`);
      } if (evt.target.dataset.name === _const__WEBPACK_IMPORTED_MODULE_2__.FilterType.HISTORY) {
        this._onFilterChange(evt.target.dataset.name);
        this._siteMenu.changeActive(`HISTORY`);
      } if (evt.target.dataset.name === _const__WEBPACK_IMPORTED_MODULE_2__.FilterType.FAVORITES) {
        this._onFilterChange(evt.target.dataset.name);
        this._siteMenu.changeActive(`FAVORITES`);
      } if (evt.target.dataset.name === _const__WEBPACK_IMPORTED_MODULE_2__.FilterType.ALL) {
        this._onFilterChange(evt.target.dataset.name);
...
/* harmony export */ });
/* harmony import */ var _utils_site_menu_filter_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/site-menu-filter.js */ "./src/utils/site-menu-filter.js");
...
class Movies {
  ...
  getFilms() {
    return (0,_utils_site_menu_filter_js__WEBPACK_IMPORTED_MODULE_0__.getFilmsByFilter)(this._films, this._activeFilterType);
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setEventPopupOpenAndCloseHandlers": () => (/* binding */ setEventPopupOpenAndCloseHandlers),
/* harmony export */   "setFilmCardsHandlers": () => (/* binding */ setFilmCardsHandlers),
/* harmony export */   "setFilmPopupHandlers": () => (/* binding */ setFilmPopupHandlers)
/* harmony export */ });
...
const setFilmCardsHandlers = (film, filmCard, onDataChange) => {
...
const setFilmPopupHandlers = (film, filmPopup, onDataChange) => {
...
/* harmony export */   "getDateForMoment": () => (/* binding */ getDateForMoment),
/* harmony export */   "getHumanizeDate": () => (/* binding */ getHumanizeDate),
/* harmony export */   "getHumanizeDate2": () => (/* binding */ getHumanizeDate2)
/* harmony export */ });
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);
...
const getDuration = (film) => {
  return `${moment__WEBPACK_IMPORTED_MODULE_0___default().duration(film.filmDuration * 1000 * 60).hours()}h ${moment__WEBPACK_IMPORTED_MODULE_0___default().duration(film.filmDuration * 1000 * 60).minutes()}m`;
};

const getDateForMoment = (obj, format) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(obj).utc().format(format);
};

const getHumanizeDate = (obj) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(obj).fromNow();
};

const getHumanizeDate2 = (obj) => {
  const date = Math.round((new Date() - moment__WEBPACK_IMPORTED_MODULE_0___default()(obj) + (3 * 60 * 60 * 1000)) / 1000 / 60);
  if (date < 1) {
    return `now`;
...
/* harmony import */ var _moment_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./moment.js */ "./src/utils/moment.js");
...
const renderSortFilms = (films, sortType) => {
  ...
  switch (sortType) {
    case _components_sort_js__WEBPACK_IMPORTED_MODULE_0__.SortType.DATE:
      sortedFilms = filmCardsSort.sort((a, b) => +(0,_moment_js__WEBPACK_IMPORTED_MODULE_1__.getDateForMoment)(b.filmYear, `YYYY`) - (+(0,_moment_js__WEBPACK_IMPORTED_MODULE_1__.getDateForMoment)(a.filmYear, `YYYY`)));
      break;
...
const getFilmsByFilter = (films, filterType) => {
  if (filterType === _const_js__WEBPACK_IMPORTED_MODULE_0__.FilterType.WATCHLIST) {
    return films.filter((film) => film.filter.watchlist === true);
  } else if (filterType === _const_js__WEBPACK_IMPORTED_MODULE_0__.FilterType.HISTORY) {
    return films.filter((film) => film.filter.history === true);
  } else if (filterType === _const_js__WEBPACK_IMPORTED_MODULE_0__.FilterType.FAVORITES) {
...
/* harmony import */ var _controllers_page_controllers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./controllers/page-controllers.js */ "./src/controllers/page-controllers.js");
/* harmony import */ var _controllers_site_menu_controller_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controllers/site-menu-controller.js */ "./src/controllers/site-menu-controller.js");
/* harmony import */ var _models_movies_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/movies.js */ "./src/models/movies.js");
/* harmony import */ var _components_stats_component_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/stats-component.js */ "./src/components/stats-component.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _components_loading_message_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/loading-message.js */ "./src/components/loading-message.js");
...
const api = new _api_js__WEBPACK_IMPORTED_MODULE_0__["default"](AUTHORIZATION, END_POINT);
const movieModel = new _models_movies_js__WEBPACK_IMPORTED_MODULE_3__["default"]();

const siteMenuController = new _controllers_site_menu_controller_js__WEBPACK_IMPORTED_MODULE_2__.SiteMenuController(main, movieModel);
const stats = new _components_stats_component_js__WEBPACK_IMPORTED_MODULE_4__["default"](movieModel);
const pageController = new _controllers_page_controllers_js__WEBPACK_IMPORTED_MODULE_1__["default"](main, movieModel, siteMenuController, api);

const messageLoading = new _components_loading_message_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_5__.render)(main, messageLoading);
...
api.getFilms()
  .then((films) => {
    ...
    renderSiteMenu();
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_5__.render)(main, stats);
