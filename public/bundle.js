...
/* harmony import */ var _components_site_menu_and_stats_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/site-menu-and-stats.js */ "./src/components/site-menu-and-stats.js");
/* harmony import */ var _components_top_rated_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/top-rated.js */ "./src/components/top-rated.js");
/* harmony import */ var _components_most_commented_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/most-commented.js */ "./src/components/most-commented.js");
/* harmony import */ var _components_no_films_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/no-films.js */ "./src/components/no-films.js");
/* harmony import */ var _components_button_show_more_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/button-show-more.js */ "./src/components/button-show-more.js");
/* harmony import */ var _movie_controller_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./movie-controller.js */ "./src/controllers/movie-controller.js");
...
/* harmony import */ var _mock_random_rating_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../mock/random-rating.js */ "./src/mock/random-rating.js");
/* harmony import */ var _mock_random_generator_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../mock/random-generator.js */ "./src/mock/random-generator.js");
...
const TOTAL_FILMS = (0,_mock_random_generator_js__WEBPACK_IMPORTED_MODULE_12__.getRandomInt)(1000, 100000);
...
const renderFilms = (container, films, onDataChange, onViewChange) => {
  return films.map((film) => {
    const movieController = new _movie_controller_js__WEBPACK_IMPORTED_MODULE_9__["default"](container, onDataChange, onViewChange);
...
class PageController {
  constructor(container) {
    ...
    this._buttonShowMore = new _components_button_show_more_js__WEBPACK_IMPORTED_MODULE_8__["default"]();
    this._topRated = new _components_top_rated_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._mostCommented = new _components_most_commented_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
  ...
  render(films) {
    ...
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_10__.render)(header, new _components_profile_rating_js__WEBPACK_IMPORTED_MODULE_1__["default"](_mock_random_rating_js__WEBPACK_IMPORTED_MODULE_11__.randomProfileRating));

    this._siteMenu = new _components_site_menu_and_stats_js__WEBPACK_IMPORTED_MODULE_4__["default"](this._films);
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_10__.render)(this._container, this._siteMenu);

    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_10__.render)(this._container, this._sort);

    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_10__.renderContainer)(this._container, this.filmCards);
    ...
    if (this._films.length === 0 || !this._films) {
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_10__.render)(this._container, new _components_no_films_js__WEBPACK_IMPORTED_MODULE_7__["default"]());
      return;
    }
    ...
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_10__.render)(filmlist, this._buttonShowMore);

    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_10__.renderContainer)(filmsElement, this._topRated);
    ...
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_10__.renderContainer)(filmsElement, this._mostCommented);
    ...
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_10__.render)(footerStatistics, new _components_footer_statistic_js__WEBPACK_IMPORTED_MODULE_3__["default"](TOTAL_FILMS));
  }
  ...
  _setSortTypeChangeHadnler() {
    ...
    this._sort.setSortTypeChangeHandler((sortType) => {
      ...
      this._filmCardsSort = (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_10__.renderSortFilms)(this._films, sortType);
  ...
  _renderOnButtonClick() {
    ...
    const renderOnButtonClick = () => {
      ...
      if (this._filmAmount >= this._films.length) {
        (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_10__.remove)(this._buttonShowMore);
      }
    };
  ...
  _onDataChange(oldData, newData) {
    ...
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_10__.remove)(this._siteMenu);
    this._siteMenu = new _components_site_menu_and_stats_js__WEBPACK_IMPORTED_MODULE_4__["default"](this._films);
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_10__.render)(this._container, this._siteMenu, `afterbegin`);
